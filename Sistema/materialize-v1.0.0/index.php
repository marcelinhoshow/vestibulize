...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="fixed-action-btn">
      <a href="#nav" id="scale-demo" class="btn-floating btn-large cale-transition scale-out teal accent-4">
  ...
  <footer class="page-footer teal" id="footer1">
    ...
    <script type="text/javascript">
    	jQuery('.fixed-action-btn').hide();
      jQuery(document).ready(function() {
          var windowHeight = window.innerHeight;
            // Exibe ou oculta o botão
            jQuery(window).scroll(function() {
                if (jQuery(this).scrollTop() > windowHeight - 200) {
                    jQuery('.fixed-action-btn').fadeIn(200);
                } else {
                    jQuery('.fixed-action-btn').fadeOut(200);
                }
            });
            
            // Faz animação para subir
            jQuery('.fixed-action-btn').click(function(event) {
